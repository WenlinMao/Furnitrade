...
class ProfilePage extends Component {
    ...
    render() {
        ...
        return (
            ...
            <
            div className = "profile-page-container" > { /* Major part one - nav bar */ } <
            NavigationBar hasLogin = {
                this.state.hasLogin
            }
            className = "nav-bar" / >
            ...
            title = "user-photo"
            src = {
                require("../../static/images/" + this.state.picture)
            }
            ...
            onChange = {
                this.handleAddressInput('address')
            }
            />
